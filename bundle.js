...
function (_List) {
  ...
  function TodoList() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(TodoList).call(this)); //adicionando mais uma informação para a classe
  ...
  return TodoList;
}(List); //instanciando a classe TodoList


var MinhaLista = new TodoList(); //Pegando o elemento html e atribuindo o envento click
